"""Apply the End-to-end framework to our dataset of NMC pounch cells."""
import time
import os
import sys
import inspect
...
if __name__ == '__main__':
    ...
    result_path = disk_path + project_path + \
        '/End to End Framework/Trained models/' \
        + DATASET + '/'
    if not os.path.exists(result_path):
        os.makedirs(result_path)

    for trial_idx in range(num_trials):
        training_input_queue.put(
            (
                trial_idx, training_dataloader,
