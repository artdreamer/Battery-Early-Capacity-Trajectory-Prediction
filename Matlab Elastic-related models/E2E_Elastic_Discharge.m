...
clear all
load processed_dataset_E2E_Elastic_discharge
...
alpha_optimal = 0.026252439421597;
l1_ratio = 0.084649188617225;
lambda = 0.165000000000000;
num_capacities = 1:100;
[beta_opt, cvx_val, ~, ~] = joint_optimization_log10_cycle(x_scale(:, index_x_selected), log10(cycle_specific_capacirty(cells_train,num_capacities)), cycle_lives(cells_train),...
...
%% Evaluation
% emporical mode params
num_capacities = 1:100;
log10_a_bar_train = x_scale(:, index_x_selected)*beta_opt(1:num_features_selected)+beta_opt(num_features_selected+1);
b_bar_train = x_scale(:, index_x_selected)*beta_opt(num_features_selected+2:end-1)+beta_opt(end);
log10_cycle_lives_train_es = (log10(1-abs_capacities(cells_train, num_capacities)./Initial_capacity(cells_train))-log10_a_bar_train)./b_bar_train;
cycle_lives_train_es = 10.^log10_cycle_lives_train_es;
log10_a_bar_test1 = x_scale_test1(:, index_x_selected)*beta_opt(1:num_features_selected)+beta_opt(num_features_selected+1);
b_bar_test1 = x_scale_test1(:, index_x_selected)*beta_opt(num_features_selected+2:end-1)+beta_opt(end);
log10_cycle_lives_test1_es = (log10(1-abs_capacities(cells_test1, num_capacities)./Initial_capacity(cells_test1))-log10_a_bar_test1)./b_bar_test1;
cycle_lives_test1_es = 10.^log10_cycle_lives_test1_es;
log10_a_bar_test2 = x_scale_test2(:, index_x_selected)*beta_opt(1:num_features_selected)+beta_opt(num_features_selected+1);
b_bar_test2 = x_scale_test2(:, index_x_selected)*beta_opt(num_features_selected+2:end-1)+beta_opt(end);
log10_cycle_lives_test2_es = (log10(1-abs_capacities(cells_test2, num_capacities)./Initial_capacity(cells_test2))-log10_a_bar_test2)./b_bar_test2;
cycle_lives_test2_es = 10.^log10_cycle_lives_test2_es;
log10_a_bar_test3 = x_scale_test3(:, index_x_selected)*beta_opt(1:num_features_selected)+beta_opt(num_features_selected+1);
b_bar_test3 = x_scale_test3(:, index_x_selected)*beta_opt(num_features_selected+2:end-1)+beta_opt(end);
log10_cycle_lives_test3_es = (log10(1-abs_capacities(cells_test3, num_capacities)./Initial_capacity(cells_test3))-log10_a_bar_test3)./b_bar_test3;
...
mpe_cycle_train = mean(mean(abs((cycle_lives_train_es-cycle_specific_capacirty(cells_train,num_capacities))./cycle_specific_capacirty(cells_train,num_capacities))));
map_cycle_test1 = mean(mean(abs((cycle_lives_test1_es-cycle_specific_capacirty(cells_test1,num_capacities))./cycle_specific_capacirty(cells_test1,num_capacities))));
map_cycle_test2 = mean(mean(abs((cycle_lives_test2_es-cycle_specific_capacirty(cells_test2,num_capacities))./cycle_specific_capacirty(cells_test2,num_capacities))));
map_cycle_test3 = mean(mean(abs((cycle_lives_test3_es-cycle_specific_capacirty(cells_test3,num_capacities))./cycle_specific_capacirty(cells_test3,num_capacities))));
