...
clear all
load processed_dataset_SeqOpt_Elastic_deltaQ
...
[B_elasticnet1,FitInfo_elasticnet1] = lasso(x_scale, log10aTrain,...
...
[B_elasticnet2,FitInfo_elasticnet2] = lasso(x_scale, bTrain,...
                    'Alpha',l1_ratio, 'Lambda', alpha_optimal, 'Standardize', false);
beta_opt2 = [B_elasticnet2; FitInfo_elasticnet2.Intercept];

%% Evaluation
% Prediction accuracy calculation
log10a_train_es = x_scale*beta_opt1(1:num_features_selected)+beta_opt1(end);
b_train_es = x_scale*beta_opt2(1:num_features_selected)+beta_opt2(end);
...
log10a_test1_es = x_scale_test1*beta_opt1(1:num_features_selected)+beta_opt1(end);
b_test1_es = x_scale_test1*beta_opt2(1:num_features_selected)+beta_opt2(end);
...
log10a_test2_es = x_scale_test2*beta_opt1(1:num_features_selected)+beta_opt1(end);
b_test2_es = x_scale_test2*beta_opt2(1:num_features_selected)+beta_opt2(end);
...
log10a_test3_es = x_scale_test3*beta_opt1(1:num_features_selected)+beta_opt1(end);
b_test3_es = x_scale_test3*beta_opt2(1:num_features_selected)+beta_opt2(end);
